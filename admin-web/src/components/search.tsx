...
export function Search({
  ...
  // Use useContext directly to check if provider is available
  const searchContext = useContext(SearchContext)
  
  // If SearchProvider is not available, return null (shouldn't happen in normal flow)
  if (!searchContext) {
    console.warn('Search component used outside SearchProvider - this should not happen')
    return null
  }
